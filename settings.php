...
<body class="standard">
  <div id="container">
    <div class="miblink">
      <a class="miblink" href="includes/TOTALHIGHSPEED-MIB.txt">SNMP MIB</a>
    </div>
    ...
    <div class="body">
      ...
      <form method=post>
        <span style="color:#900;">
          ...
          If you make changes on this page and do not write them to disk they<br />
          will be lost after a reboot unless you manually write the changes to<br />
          disk using the button below.<br />
        </span><br />
      ...
      if(isset($_POST['submit_toggle_1'])){
        $toggle = 4; // Relay 1 pin 16 is tied to GPIO 4
        $toggle_time = $_POST['toggle_time_1'];
      }elseif(isset($_POST['submit_toggle_2'])){
        $toggle = 3;  // Relay 2 pin 15 is tied to GPIO 4
